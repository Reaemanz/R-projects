...
author: "Emmanuel Reagan Nsubuga"
date: "6 March 2022"
output:
  word_document:
    toc: yes
...
train <- read.csv('R:/R Programming/Titanic dataset/train.csv', stringsAsFactors = F)
test  <- read.csv('R:/R Programming/Titanic dataset/test.csv', stringsAsFactors = F)
...
We could definitely use `rpart` (recursive partitioning for regression) to predict missing ages, but I'm going to use the `mice` package for this task just for something different. Since we haven't done it yet, I'll first factorize the factor variables and then perform mice imputation.
